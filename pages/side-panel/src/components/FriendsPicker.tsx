    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-philonet-card border border-philonet-border rounded-xl w-full max-w-md max-h-[80vh] overflow-hidden"
          onClick={(e) => e.stopPropagation()}
        >
          {/* Header */}
          <div className="p-4 border-b border-philonet-border flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Users className="w-5 h-5 text-philonet-blue-400" />
              <h3 className="text-lg font-medium text-philonet-text-primary">Add Friends</h3>
            </div>
            <button
              onClick={handleCancel}
          ...
          {localSelectedFriends.length > 0 && (
            <div className="px-4 py-3 border-b border-philonet-border bg-philonet-blue-500/10">
          ...
          {!loading && !error && displayUsers.length > 0 && (
            <div className="p-4 border-t border-philonet-border flex items-center justify-between">
